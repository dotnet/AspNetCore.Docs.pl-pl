...
---
# <a name="enforce-a-content-security-policy-for-aspnet-core-no-locblazor"></a><span data-ttu-id="d8775-103">Wymuś zasady zabezpieczeń zawartości dla ASP.NET Core :::no-loc(Blazor):::</span><span class="sxs-lookup"><span data-stu-id="d8775-103">Enforce a Content Security Policy for ASP.NET Core :::no-loc(Blazor):::</span></span>
...
<span data-ttu-id="d8775-119">Określ w minimalny sposób następujące dyrektywy i źródła dla :::no-loc(Blazor)::: aplikacji.</span><span class="sxs-lookup"><span data-stu-id="d8775-119">Minimally, specify the following directives and sources for :::no-loc(Blazor)::: apps.</span></span> <span data-ttu-id="d8775-120">Dodaj dodatkowe dyrektywy i źródła zgodnie z wymaganiami.</span><span class="sxs-lookup"><span data-stu-id="d8775-120">Add additional directives and sources as needed.</span></span> <span data-ttu-id="d8775-121">Poniższe dyrektywy są używane w sekcji [stosowanie zasad](#apply-the-policy) w tym artykule, w której znajdują się przykładowe zasady zabezpieczeń dla :::no-loc(Blazor WebAssembly)::: i :::no-loc(Blazor Server)::: :</span><span class="sxs-lookup"><span data-stu-id="d8775-121">The following directives are used in the [Apply the policy](#apply-the-policy) section of this article, where example security policies for :::no-loc(Blazor WebAssembly)::: and :::no-loc(Blazor Server)::: are provided:</span></span>
...
* <span data-ttu-id="d8775-132">[skrypt-src](https://developer.mozilla.org/docs/Web/HTTP/Headers/Content-Security-Policy/script-src): wskazuje prawidłowe źródła dla skryptów.</span><span class="sxs-lookup"><span data-stu-id="d8775-132">[script-src](https://developer.mozilla.org/docs/Web/HTTP/Headers/Content-Security-Policy/script-src): Indicates valid sources for scripts.</span></span>
  ...
  * <span data-ttu-id="d8775-135">W :::no-loc(Blazor WebAssembly)::: aplikacji:</span><span class="sxs-lookup"><span data-stu-id="d8775-135">In a :::no-loc(Blazor WebAssembly)::: app:</span></span>
  ...
  * <span data-ttu-id="d8775-138">W :::no-loc(Blazor Server)::: aplikacji Określ wartości skrótów, aby zezwolić na ładowanie wymaganych skryptów.</span><span class="sxs-lookup"><span data-stu-id="d8775-138">In a :::no-loc(Blazor Server)::: app, specify hashes to permit required scripts to load.</span></span>
* <span data-ttu-id="d8775-139">[styl-src](https://developer.mozilla.org/docs/Web/HTTP/Headers/Content-Security-Policy/style-src): wskazuje prawidłowe źródła dla arkuszy stylów.</span><span class="sxs-lookup"><span data-stu-id="d8775-139">[style-src](https://developer.mozilla.org/docs/Web/HTTP/Headers/Content-Security-Policy/style-src): Indicates valid sources for stylesheets.</span></span>
  ...
  * <span data-ttu-id="d8775-142">Określ `unsafe-inline` , aby zezwolić na używanie wbudowanych stylów.</span><span class="sxs-lookup"><span data-stu-id="d8775-142">Specify `unsafe-inline` to allow the use of inline styles.</span></span> <span data-ttu-id="d8775-143">Deklaracja wbudowana jest wymagana dla interfejsu użytkownika w :::no-loc(Blazor Server)::: aplikacjach do ponownego połączenia klienta i serwera po początkowym żądaniu.</span><span class="sxs-lookup"><span data-stu-id="d8775-143">The inline declaration is required for the UI in :::no-loc(Blazor Server)::: apps for reconnecting the client and server after the initial request.</span></span> <span data-ttu-id="d8775-144">W przyszłej wersji style wbudowane mogą zostać usunięte, aby `unsafe-inline` nie były już wymagane.</span><span class="sxs-lookup"><span data-stu-id="d8775-144">In a future release, inline styling might be removed so that `unsafe-inline` is no longer required.</span></span>
...
<span data-ttu-id="d8775-160">W poniższych sekcjach przedstawiono przykładowe zasady dla :::no-loc(Blazor WebAssembly)::: i :::no-loc(Blazor Server)::: .</span><span class="sxs-lookup"><span data-stu-id="d8775-160">The following sections show example policies for :::no-loc(Blazor WebAssembly)::: and :::no-loc(Blazor Server):::.</span></span> <span data-ttu-id="d8775-161">Te przykłady dotyczą wersji tego artykułu dla każdej wersji programu :::no-loc(Blazor)::: .</span><span class="sxs-lookup"><span data-stu-id="d8775-161">These examples are versioned with this article for each release of :::no-loc(Blazor):::.</span></span> <span data-ttu-id="d8775-162">Aby użyć wersji odpowiedniej dla wersji, wybierz wersję dokumentu z selektorem listy rozwijanej **wersji** na tej stronie sieci Web.</span><span class="sxs-lookup"><span data-stu-id="d8775-162">To use a version appropriate for your release, select the document version with the **Version** drop down selector on this webpage.</span></span>
