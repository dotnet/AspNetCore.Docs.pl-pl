...
<span data-ttu-id="7c7f9-442">Dodaj następujący znacznik na końcu strony */instruktorów/index. cshtml* :::no-loc(Razor)::: :</span><span class="sxs-lookup"><span data-stu-id="7c7f9-442">Add the following markup to the end of the *Pages/Instructors/Index.cshtml* :::no-loc(Razor)::: Page:</span></span>
