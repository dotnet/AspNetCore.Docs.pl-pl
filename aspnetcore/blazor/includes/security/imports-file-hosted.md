...
ms.locfileid: "100551761"
---
<span data-ttu-id="a29d5-101"><xref:Microsoft.AspNetCore.Components.Authorization?displayProperty=fullName>Przestrzeń nazw jest udostępniana w całej aplikacji za pośrednictwem `_Imports.razor` pliku:</span><span class="sxs-lookup"><span data-stu-id="a29d5-101">The <xref:Microsoft.AspNetCore.Components.Authorization?displayProperty=fullName> namespace is made available throughout the app via the `_Imports.razor` file:</span></span>
