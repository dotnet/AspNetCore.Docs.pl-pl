...
<details>
    ...
    <ul>
        ...
        <li><span data-ttu-id="708b8-141">Microsoft. AspNetCore. Authentication. :::no-loc(Cookie)::: wolumin</span><span class="sxs-lookup"><span data-stu-id="708b8-141">Microsoft.AspNetCore.Authentication.:::no-loc(Cookie):::s</span></span></li>
        ...
        <li><span data-ttu-id="708b8-145">Microsoft. AspNetCore. :::no-loc(Cookie)::: Zasad</span><span class="sxs-lookup"><span data-stu-id="708b8-145">Microsoft.AspNetCore.:::no-loc(Cookie):::Policy</span></span></li>
        ...
        <li><span data-ttu-id="708b8-159">Microsoft. AspNetCore.:::no-loc(Identity):::</span><span class="sxs-lookup"><span data-stu-id="708b8-159">Microsoft.AspNetCore.:::no-loc(Identity):::</span></span></li>
        ...
        <li><span data-ttu-id="708b8-173">Microsoft. AspNetCore. MVC.:::no-loc(Razor):::</span><span class="sxs-lookup"><span data-stu-id="708b8-173">Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::</span></span></li>
        <li><span data-ttu-id="708b8-174">Microsoft. AspNetCore. MVC. :::no-loc(Razor)::: .. ViewCompilation</span><span class="sxs-lookup"><span data-stu-id="708b8-174">Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.ViewCompilation</span></span></li>
        <li><span data-ttu-id="708b8-175">Microsoft. AspNetCore. MVC. :::no-loc(Razor)::: Page</span><span class="sxs-lookup"><span data-stu-id="708b8-175">Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages</span></span></li>
        ...
        <li><span data-ttu-id="708b8-178">Microsoft. AspNetCore.:::no-loc(Razor):::</span><span class="sxs-lookup"><span data-stu-id="708b8-178">Microsoft.AspNetCore.:::no-loc(Razor):::</span></span></li>
        <li><span data-ttu-id="708b8-179">Microsoft. AspNetCore. :::no-loc(Razor)::: . Środowiska uruchomieniowego</span><span class="sxs-lookup"><span data-stu-id="708b8-179">Microsoft.AspNetCore.:::no-loc(Razor):::.Runtime</span></span></li>
        <li><span data-ttu-id="708b8-180">Microsoft. AspNetCore. :::no-loc(Razor)::: . Zdefiniowanych</span><span class="sxs-lookup"><span data-stu-id="708b8-180">Microsoft.AspNetCore.:::no-loc(Razor):::.Design</span></span></li>
        ...
        <li><span data-ttu-id="708b8-196">Microsoft. AspNetCore.:::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="708b8-196">Microsoft.AspNetCore.:::no-loc(SignalR):::</span></span></li>
        <li><span data-ttu-id="708b8-197">Microsoft. AspNetCore. :::no-loc(SignalR)::: . Procesor</span><span class="sxs-lookup"><span data-stu-id="708b8-197">Microsoft.AspNetCore.:::no-loc(SignalR):::.Core</span></span></li>
...
<span data-ttu-id="708b8-250">Na poniższej ilustracji przedstawiono dodane i zmienione wiersze w :::no-loc(Razor)::: aplikacji sieci Web ASP.NET Core 3,0:</span><span class="sxs-lookup"><span data-stu-id="708b8-250">The following image shows the added and changed lines in an ASP.NET Core 3.0 :::no-loc(Razor)::: Pages Web app:</span></span>
...
### <a name="use-newtonsoftjson-in-an-aspnet-core-30-no-locsignalr-project"></a><span data-ttu-id="708b8-340">Używanie Newtonsoft.Jsw projekcie ASP.NET Core 3,0 :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="708b8-340">Use Newtonsoft.Json in an ASP.NET Core 3.0 :::no-loc(SignalR)::: project</span></span>
...
<span data-ttu-id="708b8-443">Mapowanie :::no-loc(SignalR)::: centrów odbywa się teraz w obrębie `UseEndpoints` .</span><span class="sxs-lookup"><span data-stu-id="708b8-443">Mapping of :::no-loc(SignalR)::: hubs now takes place inside `UseEndpoints`.</span></span>
...
<span data-ttu-id="708b8-446">W poniższym przykładzie `ChatHub` :::no-loc(SignalR)::: Dodano obsługę centrum:</span><span class="sxs-lookup"><span data-stu-id="708b8-446">In the following example, support for the `ChatHub` :::no-loc(SignalR)::: hub is added:</span></span>
...
### <a name="no-locrazor-pages"></a><span data-ttu-id="708b8-488">:::no-loc(Razor)::: Page</span><span class="sxs-lookup"><span data-stu-id="708b8-488">:::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="708b8-489">Na :::no-loc(Razor)::: stronach mapowania teraz odbywa się wewnątrz `UseEndpoints` .</span><span class="sxs-lookup"><span data-stu-id="708b8-489">Mapping :::no-loc(Razor)::: Pages now takes place inside `UseEndpoints`.</span></span>

<span data-ttu-id="708b8-490">Dodaj `Map:::no-loc(Razor):::Pages` , jeśli aplikacja używa :::no-loc(Razor)::: stron.</span><span class="sxs-lookup"><span data-stu-id="708b8-490">Add `Map:::no-loc(Razor):::Pages` if the app uses :::no-loc(Razor)::: Pages.</span></span> <span data-ttu-id="708b8-491">Ponieważ Routing punktów końcowych obejmuje obsługę wielu struktur, Dodawanie :::no-loc(Razor)::: stron jest teraz zgodą.</span><span class="sxs-lookup"><span data-stu-id="708b8-491">Since Endpoint Routing includes support for many frameworks, adding :::no-loc(Razor)::: Pages is now opt-in.</span></span>

<span data-ttu-id="708b8-492">W następującej `Startup.Configure` metodzie program `Map:::no-loc(Razor):::Pages` dodaje obsługę :::no-loc(Razor)::: stron:</span><span class="sxs-lookup"><span data-stu-id="708b8-492">In the following `Startup.Configure` method, `Map:::no-loc(Razor):::Pages` adds support for :::no-loc(Razor)::: Pages:</span></span>
...
## <a name="no-locidentity-ui"></a><span data-ttu-id="708b8-527">:::no-loc(Identity)::: INTERFEJSU użytkownika</span><span class="sxs-lookup"><span data-stu-id="708b8-527">:::no-loc(Identity)::: UI</span></span>

<span data-ttu-id="708b8-528">:::no-loc(Identity)::: Aktualizacje interfejsu użytkownika dla ASP.NET Core 3,0:</span><span class="sxs-lookup"><span data-stu-id="708b8-528">:::no-loc(Identity)::: UI updates for ASP.NET Core 3.0:</span></span>

* <span data-ttu-id="708b8-529">Dodaj odwołanie do pakietu do [Microsoft. AspNetCore. :::no-loc(Identity)::: . Interfejs użytkownika](https://nuget.org/packages/Microsoft.AspNetCore.:::no-loc(Identity):::.UI).</span><span class="sxs-lookup"><span data-stu-id="708b8-529">Add a package reference to [Microsoft.AspNetCore.:::no-loc(Identity):::.UI](https://nuget.org/packages/Microsoft.AspNetCore.:::no-loc(Identity):::.UI).</span></span>
* <span data-ttu-id="708b8-530">Aplikacje, które nie korzystają ze :::no-loc(Razor)::: stron, muszą wywoływać `Map:::no-loc(Razor):::Pages` .</span><span class="sxs-lookup"><span data-stu-id="708b8-530">Apps that don't use :::no-loc(Razor)::: Pages must call `Map:::no-loc(Razor):::Pages`.</span></span> <span data-ttu-id="708b8-531">Zobacz [ :::no-loc(Razor)::: strony](#razor-pages) w tym dokumencie.</span><span class="sxs-lookup"><span data-stu-id="708b8-531">See [:::no-loc(Razor)::: Pages](#razor-pages) in this document.</span></span>
* <span data-ttu-id="708b8-532">Uruchomienie Bootstrap 4 jest domyślną strukturą interfejsu użytkownika.</span><span class="sxs-lookup"><span data-stu-id="708b8-532">Bootstrap 4 is the default UI framework.</span></span> <span data-ttu-id="708b8-533">Ustaw `:::no-loc(Identity):::UIFrameworkVersion` Właściwość projektu w celu zmiany wartości domyślnej.</span><span class="sxs-lookup"><span data-stu-id="708b8-533">Set an `:::no-loc(Identity):::UIFrameworkVersion` project property to change the default.</span></span> <span data-ttu-id="708b8-534">Aby uzyskać więcej informacji, zobacz [ten anons usługi GitHub](https://github.com/aspnet/Announcements/issues/380).</span><span class="sxs-lookup"><span data-stu-id="708b8-534">For more information, see [this GitHub announcement](https://github.com/aspnet/Announcements/issues/380).</span></span>

## :::no-loc(SignalR):::

<span data-ttu-id="708b8-535">:::no-loc(SignalR):::Klient JavaScript zmienił `@aspnet/signalr` się z na `@microsoft/signalr` .</span><span class="sxs-lookup"><span data-stu-id="708b8-535">The :::no-loc(SignalR)::: JavaScript client has changed from `@aspnet/signalr` to `@microsoft/signalr`.</span></span> <span data-ttu-id="708b8-536">Aby reagować na tę zmianę, Zmień odwołania w *package.jsw* plikach, `require` instrukcjach i `import` instrukcjach języka ECMAScript.</span><span class="sxs-lookup"><span data-stu-id="708b8-536">To react to this change, change the references in *package.json* files, `require` statements, and ECMAScript `import` statements.</span></span>
...
1. <span data-ttu-id="708b8-559">Zainstaluj [pakiet Microsoft. AspNetCore. MVC. :::no-loc(Razor)::: . ](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.RuntimeCompilation) Pakiet NuGet RuntimeCompilation.</span><span class="sxs-lookup"><span data-stu-id="708b8-559">Install the [Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.RuntimeCompilation](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.RuntimeCompilation) NuGet package.</span></span>
1. <span data-ttu-id="708b8-560">Aktualizacja `Startup.ConfigureServices` do wywołania `Add:::no-loc(Razor):::RuntimeCompilation` :</span><span class="sxs-lookup"><span data-stu-id="708b8-560">Update `Startup.ConfigureServices` to call `Add:::no-loc(Razor):::RuntimeCompilation`:</span></span>
    ...
    <span data-ttu-id="708b8-562">W przypadku :::no-loc(Razor)::: stron ASP.NET Core Użyj następującego kodu:</span><span class="sxs-lookup"><span data-stu-id="708b8-562">For ASP.NET Core :::no-loc(Razor)::: Pages, use the following code:</span></span>
...
<span data-ttu-id="708b8-564">Aby uzyskać więcej informacji na temat :::no-loc(Razor)::: kompilowania plików, zobacz <xref:mvc/views/view-compilation> .</span><span class="sxs-lookup"><span data-stu-id="708b8-564">For more information on :::no-loc(Razor)::: file compilation, see <xref:mvc/views/view-compilation>.</span></span>
