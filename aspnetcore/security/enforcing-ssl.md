...
Aby uzyskać więcej informacji, zobacz [Konfigurowanie urzędów certyfikacji w programie Firefox](https://support.mozilla.org/kb/setting-certificate-authorities-firefox).
