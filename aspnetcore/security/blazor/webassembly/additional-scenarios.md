...
Skonfigurowany <xref:System.Net.Http.HttpClient> jest następnie używany do autoryzowania żądań przy użyciu prostego wzorca [try-catch](/dotnet/csharp/language-reference/keywords/try-catch) .
