...
>
> Możliwość ustawienia `PreferExactMatches` `@false` lub pozostawienia ustawienia nie jest ustawiona, która domyślnie `false` jest opcją w języku C#, *jest dostępna tylko w celu zapewnienia zgodności z poprzednimi wersjami*.
>
