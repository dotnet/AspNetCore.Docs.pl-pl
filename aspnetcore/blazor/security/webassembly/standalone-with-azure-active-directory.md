...
Aby utworzyć Blazor WebAssembly autonomiczną aplikację korzystającą z usługi [Azure Active Directory (AAD)](https://azure.microsoft.com/services/active-directory/) do uwierzytelniania:
