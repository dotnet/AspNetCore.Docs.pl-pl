...
---
# <a name="aspnet-core-31-razor-pages-samesite-cookie-sample"></a>RazorPrzykładowy plik cookie SameSite stron ASP.NET Core 3,1
...
W kodzie pokazanym powyżej zarówno uwierzytelnianie plików cookie, jak i stan sesji Ustaw ich atrybut sameSite na None, emitując atrybut z `None` wartością, a także ustaw atrybut Secure na true.
