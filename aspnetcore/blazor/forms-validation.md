---
title: "ASP.NET Core Blazor Forms i walidacja" Author: Description: "Dowiedz się, jak używać scenariuszy formularzy i walidacji pól w Blazor ".
...
* <xref:Microsoft.AspNetCore.Components.Forms.InputText> `@bind-Value` Powiązania składnika:
  * Właściwość modelu ( `exampleModel.Name` ) do <xref:Microsoft.AspNetCore.Components.Forms.InputText> `Value` właściwości składnika. Aby uzyskać więcej informacji na temat powiązania właściwości, zobacz <xref:blazor/data-binding#parent-to-child-binding-with-component-parameters> .
...
-------- | ---title: "ASP.NET Core Blazor formularzy i walidacja" Author: Description: "Dowiedz się, jak używać scenariuszy i walidacji pól w Blazor ".
monikerRange: MS. Author: MS. Custom: MS. Date: No-Loc:
- 'Blazor'
- 'Identity'
- 'Let's Encrypt'
...
Utwórz składnik z następującą adiustacją i użyj składnika, tak jak <xref:Microsoft.AspNetCore.Components.Forms.InputText> jest używany:
