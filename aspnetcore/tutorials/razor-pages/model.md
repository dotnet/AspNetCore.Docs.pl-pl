...
---
# <a name="part-2-add-a-model-to-a-no-locrazor-pages-app-in-aspnet-core"></a><span data-ttu-id="3ea32-104">Część 2 Dodaj model do :::no-loc(Razor)::: aplikacji stron w ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="3ea32-104">Part 2, add a model to a :::no-loc(Razor)::: Pages app in ASP.NET Core</span></span>
...
<span data-ttu-id="3ea32-112">[Wyświetlanie lub Pobieranie przykładowego kodu](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/:::no-loc(Razor):::PagesMovie50) ([jak pobrać](xref:index#how-to-download-a-sample)).</span><span class="sxs-lookup"><span data-stu-id="3ea32-112">[View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/:::no-loc(Razor):::PagesMovie50) ([how to download](xref:index#how-to-download-a-sample)).</span></span>
...
1. <span data-ttu-id="3ea32-115">W **Eksplorator rozwiązań** kliknij prawym przyciskiem myszy projekt *:::no-loc(Razor)::: PagesMovie* > **Dodaj**  >  **Nowy folder**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-115">In **Solution Explorer** , right-click the *:::no-loc(Razor):::PagesMovie* project > **Add** > **New Folder**.</span></span> <span data-ttu-id="3ea32-116">Nazwij *modele* folderów.</span><span class="sxs-lookup"><span data-stu-id="3ea32-116">Name the folder *Models*.</span></span>
...
1. <span data-ttu-id="3ea32-139">W projekcie *:::no-loc(Razor)::: PagesMovie* Utwórz folder o nazwie *dane*.</span><span class="sxs-lookup"><span data-stu-id="3ea32-139">In the *:::no-loc(Razor):::PagesMovie* project, create a folder named *Data*.</span></span>
1. <span data-ttu-id="3ea32-140">W folderze *dane* Dodaj plik o nazwie *:::no-loc(Razor)::: PagesMovieContext.cs* z następującym kodem:</span><span class="sxs-lookup"><span data-stu-id="3ea32-140">In the *Data* folder, add a file named *:::no-loc(Razor):::PagesMovieContext.cs* with the following code:</span></span>
...
<span data-ttu-id="3ea32-145">Dodaj parametry połączenia do *:::no-loc(appsettings.json):::* pliku, jak pokazano w następującym wyróżnionym kodzie:</span><span class="sxs-lookup"><span data-stu-id="3ea32-145">Add a connection string to the *:::no-loc(appsettings.json):::* file as shown in the following highlighted code:</span></span>
...
1. <span data-ttu-id="3ea32-169">:::no-loc(Create)::: folder *stron/filmów* :</span><span class="sxs-lookup"><span data-stu-id="3ea32-169">:::no-loc(Create)::: a *Pages/Movies* folder:</span></span>
...
1. <span data-ttu-id="3ea32-174">W oknie dialogowym **Dodawanie szkieletu** wybierz pozycję **:::no-loc(Razor)::: strony z użyciem Entity Framework (CRUD)** > **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-174">In the **Add Scaffold** dialog, select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **Add**.</span></span>

   ![Obraz z poprzednich instrukcji.](model/_static/add_scaffold.png)

1. <span data-ttu-id="3ea32-176">Wypełnij okno dialogowe **Dodawanie :::no-loc(Razor)::: stron przy użyciu Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="3ea32-176">Complete the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>
   1. <span data-ttu-id="3ea32-177">Z listy rozwijanej **Klasa modelu** wybierz pozycję **film ( :::no-loc(Razor)::: PagesMovie. models)**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-177">In the **Model class** drop down, select **Movie (:::no-loc(Razor):::PagesMovie.Models)**.</span></span>
   1. <span data-ttu-id="3ea32-178">W wierszu **klasy kontekstu danych** wybierz **+** znak (plus).</span><span class="sxs-lookup"><span data-stu-id="3ea32-178">In the **Data context class** row, select the **+** (plus) sign.</span></span>
      1. <span data-ttu-id="3ea32-179">W oknie dialogowym **Dodawanie kontekstu danych** nazwa klasy *:::no-loc(Razor)::: PagesMovie. Data. :::no-loc(Razor)::: PagesMovieContext* jest generowany.</span><span class="sxs-lookup"><span data-stu-id="3ea32-179">In the **Add Data Context** dialog, the class name *:::no-loc(Razor):::PagesMovie.Data.:::no-loc(Razor):::PagesMovieContext* is generated.</span></span>
...
<span data-ttu-id="3ea32-182">*:::no-loc(appsettings.json):::* Plik zostanie zaktualizowany przy użyciu parametrów połączenia używanych do nawiązywania połączenia z lokalną bazą danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-182">The *:::no-loc(appsettings.json):::* file is updated with the connection string used to connect to a local database.</span></span>
...
| `--referenceScriptLibraries` | <span data-ttu-id="3ea32-194">Dodaje `_ValidationScriptsPartial` do edycji i :::no-loc(Create)::: stron</span><span class="sxs-lookup"><span data-stu-id="3ea32-194">Adds `_ValidationScriptsPartial` to Edit and :::no-loc(Create)::: pages</span></span> |
...
1. <span data-ttu-id="3ea32-202">:::no-loc(Create)::: folder *stron/filmów* :</span><span class="sxs-lookup"><span data-stu-id="3ea32-202">:::no-loc(Create)::: a *Pages/Movies* folder:</span></span>
...
1. <span data-ttu-id="3ea32-207">W oknie dialogowym **Nowa rusztowania** wybierz pozycję **:::no-loc(Razor)::: strony z Entity Framework (CRUD)** > **dalej**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-207">In the **New Scaffolding** dialog, select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **Next**.</span></span>

   ![Obraz z poprzednich instrukcji.](model/_static/add_scaffoldMac.png)

1. <span data-ttu-id="3ea32-209">Wypełnij okno dialogowe **Dodawanie :::no-loc(Razor)::: stron przy użyciu Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="3ea32-209">Complete the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>
   1. <span data-ttu-id="3ea32-210">W **klasie DbContext, aby użyć:** Row, nazwij klasę *:::no-loc(Razor)::: PagesMovie. Data. :::no-loc(Razor)::: PagesMovieContext*.</span><span class="sxs-lookup"><span data-stu-id="3ea32-210">In the **DbContext Class to use:** row, name the class *:::no-loc(Razor):::PagesMovie.Data.:::no-loc(Razor):::PagesMovieContext*.</span></span>
...
<span data-ttu-id="3ea32-213">*:::no-loc(appsettings.json):::* Plik zostanie zaktualizowany przy użyciu parametrów połączenia używanych do nawiązywania połączenia z lokalną bazą danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-213">The *:::no-loc(appsettings.json):::* file is updated with the connection string used to connect to a local database.</span></span>
...
* <span data-ttu-id="3ea32-221">*Strony/filmy* : :::no-loc(Create)::: , :::no-loc(Delete)::: , szczegóły, Edytuj i :::no-loc(Index)::: .</span><span class="sxs-lookup"><span data-stu-id="3ea32-221">*Pages/Movies* : :::no-loc(Create):::, :::no-loc(Delete):::, Details, Edit, and :::no-loc(Index):::.</span></span>
* <span data-ttu-id="3ea32-222">*Dane/ :::no-loc(Razor)::: PagesMovieContext.cs*</span><span class="sxs-lookup"><span data-stu-id="3ea32-222">*Data/:::no-loc(Razor):::PagesMovieContext.cs*</span></span>
...
* <span data-ttu-id="3ea32-228">*Strony/filmy* : :::no-loc(Create)::: , :::no-loc(Delete)::: , szczegóły, Edytuj i :::no-loc(Index)::: .</span><span class="sxs-lookup"><span data-stu-id="3ea32-228">*Pages/Movies* : :::no-loc(Create):::, :::no-loc(Delete):::, Details, Edit, and :::no-loc(Index):::.</span></span>
...
* <span data-ttu-id="3ea32-232">*Strony/filmy* : :::no-loc(Create)::: , :::no-loc(Delete)::: , szczegóły, Edytuj i :::no-loc(Index)::: .</span><span class="sxs-lookup"><span data-stu-id="3ea32-232">*Pages/Movies* : :::no-loc(Create):::, :::no-loc(Delete):::, Details, Edit, and :::no-loc(Index):::.</span></span>
* <span data-ttu-id="3ea32-233">*Dane/ :::no-loc(Razor)::: PagesMovieContext.cs*</span><span class="sxs-lookup"><span data-stu-id="3ea32-233">*Data/:::no-loc(Razor):::PagesMovieContext.cs*</span></span>
...
## <a name="no-loccreate-the-initial-database-schema-using-efs-migration-feature"></a><span data-ttu-id="3ea32-237">:::no-loc(Create)::: początkowy schemat bazy danych przy użyciu funkcji migracji EF</span><span class="sxs-lookup"><span data-stu-id="3ea32-237">:::no-loc(Create)::: the initial database schema using EF's migration feature</span></span>
...
* <span data-ttu-id="3ea32-239">:::no-loc(Create)::: początkowy schemat bazy danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-239">:::no-loc(Create)::: the initial database schema.</span></span>
...
<span data-ttu-id="3ea32-255">`migrations`Polecenie generuje kod, aby utworzyć początkowy schemat bazy danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-255">The `migrations` command generates code to create the initial database schema.</span></span> <span data-ttu-id="3ea32-256">Schemat jest oparty na modelu określonym w `DbContext` .</span><span class="sxs-lookup"><span data-stu-id="3ea32-256">The schema is based on the model specified in `DbContext`.</span></span> <span data-ttu-id="3ea32-257">`Initial:::no-loc(Create):::`Argument jest używany do nazwy migracji.</span><span class="sxs-lookup"><span data-stu-id="3ea32-257">The `Initial:::no-loc(Create):::` argument is used to name the migrations.</span></span> <span data-ttu-id="3ea32-258">Można użyć dowolnej nazwy, ale według Konwencji została wybrana nazwa opisująca migrację.</span><span class="sxs-lookup"><span data-stu-id="3ea32-258">Any name can be used, but by convention a name is selected that describes the migration.</span></span>

<span data-ttu-id="3ea32-259">`update`Polecenie uruchamia `Up` metodę w migracjach, które nie zostały zastosowane.</span><span class="sxs-lookup"><span data-stu-id="3ea32-259">The `update` command runs the `Up` method in migrations that have not been applied.</span></span> <span data-ttu-id="3ea32-260">W takim przypadku program `update` uruchamia `Up` metodę w pliku *migrations/ \<time-stamp> _Initial :::no-loc(Create)::: . cs* , który tworzy bazę danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-260">In this case, `update` runs the `Up` method in the *Migrations/\<time-stamp>_Initial:::no-loc(Create):::.cs* file, which creates the database.</span></span>
...
<span data-ttu-id="3ea32-263">ASP.NET Core jest skompilowana z [iniekcją zależności](xref:fundamentals/dependency-injection).</span><span class="sxs-lookup"><span data-stu-id="3ea32-263">ASP.NET Core is built with [dependency injection](xref:fundamentals/dependency-injection).</span></span> <span data-ttu-id="3ea32-264">Usługi, takie jak kontekst bazy danych EF Core, są rejestrowane z iniekcją zależności podczas uruchamiania aplikacji.</span><span class="sxs-lookup"><span data-stu-id="3ea32-264">Services, such as the EF Core database context, are registered with dependency injection during application startup.</span></span> <span data-ttu-id="3ea32-265">Składniki wymagające tych usług (takie jak :::no-loc(Razor)::: strony) są udostępniane przez parametry konstruktora.</span><span class="sxs-lookup"><span data-stu-id="3ea32-265">Components that require these services (such as :::no-loc(Razor)::: Pages) are provided these services via constructor parameters.</span></span> <span data-ttu-id="3ea32-266">Kod konstruktora, który pobiera wystąpienie kontekstu bazy danych jest wyświetlany w dalszej części samouczka.</span><span class="sxs-lookup"><span data-stu-id="3ea32-266">The constructor code that gets a database context instance is shown later in the tutorial.</span></span>
...
<span data-ttu-id="3ea32-270">`:::no-loc(Razor):::PagesMovieContext`Współrzędne EF Core funkcje, takie jak :::no-loc(Create)::: , Odczyt, aktualizacja i :::no-loc(Delete)::: , dla `Movie` modelu.</span><span class="sxs-lookup"><span data-stu-id="3ea32-270">The `:::no-loc(Razor):::PagesMovieContext` coordinates EF Core functionality, such as :::no-loc(Create):::, Read, Update and :::no-loc(Delete):::, for the `Movie` model.</span></span> <span data-ttu-id="3ea32-271">Kontekst danych ( `:::no-loc(Razor):::PagesMovieContext` ) pochodzi od [Microsoft. EntityFrameworkCore. DbContext](xref:Microsoft.EntityFrameworkCore.DbContext).</span><span class="sxs-lookup"><span data-stu-id="3ea32-271">The data context (`:::no-loc(Razor):::PagesMovieContext`) is derived from [Microsoft.EntityFrameworkCore.DbContext](xref:Microsoft.EntityFrameworkCore.DbContext).</span></span> <span data-ttu-id="3ea32-272">Kontekst danych określa, które jednostki są uwzględnione w modelu danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-272">The data context specifies which entities are included in the data model.</span></span>
...
1. <span data-ttu-id="3ea32-284">Przetestuj **:::no-loc(Create):::** link.</span><span class="sxs-lookup"><span data-stu-id="3ea32-284">Test the **:::no-loc(Create):::** link.</span></span>
...
1. <span data-ttu-id="3ea32-289">Przetestuj **Edytowanie** , **szczegóły** i **:::no-loc(Delete):::** linki.</span><span class="sxs-lookup"><span data-stu-id="3ea32-289">Test the **Edit** , **Details** , and **:::no-loc(Delete):::** links.</span></span>
...
>  wprowadzenie [Dalej: Rusztowania :::no-loc(Razor)::: Strony](xref:tutorials/razor-pages/page)</span><span class="sxs-lookup"><span data-stu-id="3ea32-292">[Previous: Get Started](xref:tutorials/razor-pages/razor-pages-start)
...
<span data-ttu-id="3ea32-298">[Wyświetlanie lub Pobieranie przykładowego kodu](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/:::no-loc(Razor):::PagesMovie30) ([jak pobrać](xref:index#how-to-download-a-sample)).</span><span class="sxs-lookup"><span data-stu-id="3ea32-298">[View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/:::no-loc(Razor):::PagesMovie30) ([how to download](xref:index#how-to-download-a-sample)).</span></span>
...
<span data-ttu-id="3ea32-301">Kliknij prawym przyciskiem myszy projekt **:::no-loc(Razor)::: PagesMovie** > **Dodaj**  >  **Nowy folder**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-301">Right-click the **:::no-loc(Razor):::PagesMovie** project > **Add** > **New Folder**.</span></span> <span data-ttu-id="3ea32-302">Nazwij *modele* folderów.</span><span class="sxs-lookup"><span data-stu-id="3ea32-302">Name the folder *Models*.</span></span>
...
* <span data-ttu-id="3ea32-327">W projekcie *:::no-loc(Razor)::: PagesMovie* Utwórz nowy folder o nazwie *Data*.</span><span class="sxs-lookup"><span data-stu-id="3ea32-327">In the *:::no-loc(Razor):::PagesMovie* project, create a new folder named *Data*.</span></span>
* <span data-ttu-id="3ea32-328">Dodaj następującą `:::no-loc(Razor):::PagesMovieContext` klasę do folderu *danych* :</span><span class="sxs-lookup"><span data-stu-id="3ea32-328">Add the following `:::no-loc(Razor):::PagesMovieContext` class to the *Data* folder:</span></span>
...
<span data-ttu-id="3ea32-333">Dodaj parametry połączenia do *:::no-loc(appsettings.json):::* pliku, jak pokazano w następującym wyróżnionym kodzie:</span><span class="sxs-lookup"><span data-stu-id="3ea32-333">Add a connection string to the *:::no-loc(appsettings.json):::* file as shown in the following highlighted code:</span></span>
...
<span data-ttu-id="3ea32-357">:::no-loc(Create)::: folder *stron/filmów* :</span><span class="sxs-lookup"><span data-stu-id="3ea32-357">:::no-loc(Create)::: a *Pages/Movies* folder:</span></span>
...
<span data-ttu-id="3ea32-362">W oknie dialogowym **Dodawanie szkieletu** wybierz pozycję **:::no-loc(Razor)::: strony z użyciem Entity Framework (CRUD)** > **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-362">In the **Add Scaffold** dialog, select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **Add**.</span></span>

![Obraz z poprzednich instrukcji.](model/_static/add_scaffold.png)

<span data-ttu-id="3ea32-364">Wypełnij okno dialogowe **Dodawanie :::no-loc(Razor)::: stron przy użyciu Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="3ea32-364">Complete the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>

* <span data-ttu-id="3ea32-365">Z listy rozwijanej **Klasa modelu** wybierz pozycję **film ( :::no-loc(Razor)::: PagesMovie. models)**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-365">In the **Model class** drop down, select **Movie (:::no-loc(Razor):::PagesMovie.Models)**.</span></span>
* <span data-ttu-id="3ea32-366">W wierszu **klasy kontekstu danych** wybierz **+** znak (plus), a następnie zmień wygenerowaną nazwę z :::no-loc(Razor)::: PagesMovie. **Modele**. :::no-loc(Razor)::: PagesMovieContext do :::no-loc(Razor)::: PagesMovie. **Dane**. :::no-loc(Razor)::: PagesMovieContext.</span><span class="sxs-lookup"><span data-stu-id="3ea32-366">In the **Data context class** row, select the **+** (plus) sign and change the generated name from :::no-loc(Razor):::PagesMovie. **Models**.:::no-loc(Razor):::PagesMovieContext to :::no-loc(Razor):::PagesMovie. **Data**.:::no-loc(Razor):::PagesMovieContext.</span></span> <span data-ttu-id="3ea32-367">[Ta zmiana](https://developercommunity.visualstudio.com/content/problem/652166/aspnet-core-ef-scaffolder-uses-incorrect-namespace.html) nie jest wymagana.</span><span class="sxs-lookup"><span data-stu-id="3ea32-367">[This change](https://developercommunity.visualstudio.com/content/problem/652166/aspnet-core-ef-scaffolder-uses-incorrect-namespace.html) is not required.</span></span> <span data-ttu-id="3ea32-368">Tworzy klasę kontekstu bazy danych z poprawną przestrzenią nazw.</span><span class="sxs-lookup"><span data-stu-id="3ea32-368">It creates the database context class with the correct namespace.</span></span>
...
<span data-ttu-id="3ea32-371">*:::no-loc(appsettings.json):::* Plik zostanie zaktualizowany przy użyciu parametrów połączenia używanych do nawiązywania połączenia z lokalną bazą danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-371">The *:::no-loc(appsettings.json):::* file is updated with the connection string used to connect to a local database.</span></span>
...
| `--referenceScriptLibraries` | <span data-ttu-id="3ea32-383">Dodaje `_ValidationScriptsPartial` do edycji i :::no-loc(Create)::: stron</span><span class="sxs-lookup"><span data-stu-id="3ea32-383">Adds `_ValidationScriptsPartial` to Edit and :::no-loc(Create)::: pages</span></span> |
...
<span data-ttu-id="3ea32-391">:::no-loc(Create)::: folder *stron/filmów* :</span><span class="sxs-lookup"><span data-stu-id="3ea32-391">:::no-loc(Create)::: a *Pages/Movies* folder:</span></span>
...
<span data-ttu-id="3ea32-396">W oknie dialogowym **Nowa rusztowania** wybierz pozycję **:::no-loc(Razor)::: strony z Entity Framework (CRUD)** > **dalej**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-396">In the **New Scaffolding** dialog, select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **Next**.</span></span>

![Obraz z poprzednich instrukcji.](model/_static/add_scaffoldMac.png)

<span data-ttu-id="3ea32-398">Wypełnij okno dialogowe **Dodawanie :::no-loc(Razor)::: stron przy użyciu Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="3ea32-398">Complete the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>

* <span data-ttu-id="3ea32-399">W menu rozwijanym **Klasa modelu** wybierz lub wpisz **film ( :::no-loc(Razor)::: PagesMovie. models)**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-399">In the **Model class** drop down, select, or type, **Movie (:::no-loc(Razor):::PagesMovie.Models)**.</span></span>
* <span data-ttu-id="3ea32-400">W wierszu **klasy kontekstu danych** wpisz nazwę nowej klasy, :::no-loc(Razor)::: PagesMovie. **Dane**. :::no-loc(Razor)::: PagesMovieContext.</span><span class="sxs-lookup"><span data-stu-id="3ea32-400">In the **Data context class** row, type the name for the new class, :::no-loc(Razor):::PagesMovie. **Data**.:::no-loc(Razor):::PagesMovieContext.</span></span> <span data-ttu-id="3ea32-401">[Ta zmiana](https://developercommunity.visualstudio.com/content/problem/652166/aspnet-core-ef-scaffolder-uses-incorrect-namespace.html) nie jest wymagana.</span><span class="sxs-lookup"><span data-stu-id="3ea32-401">[This change](https://developercommunity.visualstudio.com/content/problem/652166/aspnet-core-ef-scaffolder-uses-incorrect-namespace.html) is not required.</span></span> <span data-ttu-id="3ea32-402">Tworzy klasę kontekstu bazy danych z poprawną przestrzenią nazw.</span><span class="sxs-lookup"><span data-stu-id="3ea32-402">It creates the database context class with the correct namespace.</span></span>
...
<span data-ttu-id="3ea32-405">*:::no-loc(appsettings.json):::* Plik zostanie zaktualizowany przy użyciu parametrów połączenia używanych do nawiązywania połączenia z lokalną bazą danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-405">The *:::no-loc(appsettings.json):::* file is updated with the connection string used to connect to a local database.</span></span>
...
* <span data-ttu-id="3ea32-417">*Strony/filmy* : :::no-loc(Create)::: , :::no-loc(Delete)::: , szczegóły, Edytuj i :::no-loc(Index)::: .</span><span class="sxs-lookup"><span data-stu-id="3ea32-417">*Pages/Movies* : :::no-loc(Create):::, :::no-loc(Delete):::, Details, Edit, and :::no-loc(Index):::.</span></span>
* <span data-ttu-id="3ea32-418">*Dane/ :::no-loc(Razor)::: PagesMovieContext.cs*</span><span class="sxs-lookup"><span data-stu-id="3ea32-418">*Data/:::no-loc(Razor):::PagesMovieContext.cs*</span></span>
...
* <span data-ttu-id="3ea32-424">*Strony/filmy* : :::no-loc(Create)::: , :::no-loc(Delete)::: , szczegóły, Edytuj i :::no-loc(Index)::: .</span><span class="sxs-lookup"><span data-stu-id="3ea32-424">*Pages/Movies* : :::no-loc(Create):::, :::no-loc(Delete):::, Details, Edit, and :::no-loc(Index):::.</span></span>
* <span data-ttu-id="3ea32-425">*Dane/ :::no-loc(Razor)::: PagesMovieContext.cs*</span><span class="sxs-lookup"><span data-stu-id="3ea32-425">*Data/:::no-loc(Razor):::PagesMovieContext.cs*</span></span>
...
* <span data-ttu-id="3ea32-431">*Strony/filmy* : :::no-loc(Create)::: , :::no-loc(Delete)::: , szczegóły, Edytuj i :::no-loc(Index)::: .</span><span class="sxs-lookup"><span data-stu-id="3ea32-431">*Pages/Movies* : :::no-loc(Create):::, :::no-loc(Delete):::, Details, Edit, and :::no-loc(Index):::.</span></span>
...
<span data-ttu-id="3ea32-447">Polecenie migrations generuje kod, aby utworzyć początkowy schemat bazy danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-447">The migrations command generates code to create the initial database schema.</span></span> <span data-ttu-id="3ea32-448">Schemat jest oparty na modelu określonym w `DbContext` .</span><span class="sxs-lookup"><span data-stu-id="3ea32-448">The schema is based on the model specified in `DbContext`.</span></span> <span data-ttu-id="3ea32-449">`Initial:::no-loc(Create):::`Argument jest używany do nazwy migracji.</span><span class="sxs-lookup"><span data-stu-id="3ea32-449">The `Initial:::no-loc(Create):::` argument is used to name the migrations.</span></span> <span data-ttu-id="3ea32-450">Można użyć dowolnej nazwy, ale według Konwencji została wybrana nazwa opisująca migrację.</span><span class="sxs-lookup"><span data-stu-id="3ea32-450">Any name can be used, but by convention a name is selected that describes the migration.</span></span>

<span data-ttu-id="3ea32-451">`update`Polecenie uruchamia `Up` metodę w migracjach, które nie zostały zastosowane.</span><span class="sxs-lookup"><span data-stu-id="3ea32-451">The `update` command runs the `Up` method in migrations that have not been applied.</span></span> <span data-ttu-id="3ea32-452">W takim przypadku program `update` uruchamia `Up` metodę w pliku  *migrations/ \<time-stamp> _Initial :::no-loc(Create)::: . cs* , który tworzy bazę danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-452">In this case, `update` runs the `Up` method in  *Migrations/\<time-stamp>_Initial:::no-loc(Create):::.cs* file, which creates the database.</span></span>
...
<span data-ttu-id="3ea32-462">`:::no-loc(Razor):::PagesMovieContext`Współrzędne EF Core funkcje, takie jak :::no-loc(Create)::: , Odczyt, aktualizacja i :::no-loc(Delete)::: , dla `Movie` modelu.</span><span class="sxs-lookup"><span data-stu-id="3ea32-462">The `:::no-loc(Razor):::PagesMovieContext` coordinates EF Core functionality, such as :::no-loc(Create):::, Read, Update and :::no-loc(Delete):::, for the `Movie` model.</span></span> <span data-ttu-id="3ea32-463">Kontekst danych ( `:::no-loc(Razor):::PagesMovieContext` ) pochodzi od [Microsoft. EntityFrameworkCore. DbContext](xref:Microsoft.EntityFrameworkCore.DbContext).</span><span class="sxs-lookup"><span data-stu-id="3ea32-463">The data context (`:::no-loc(Razor):::PagesMovieContext`) is derived from [Microsoft.EntityFrameworkCore.DbContext](xref:Microsoft.EntityFrameworkCore.DbContext).</span></span> <span data-ttu-id="3ea32-464">Kontekst danych określa, które jednostki są uwzględnione w modelu danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-464">The data context specifies which entities are included in the data model.</span></span>
...
* <span data-ttu-id="3ea32-476">Przetestuj **:::no-loc(Create):::** link.</span><span class="sxs-lookup"><span data-stu-id="3ea32-476">Test the **:::no-loc(Create):::** link.</span></span>
...
* <span data-ttu-id="3ea32-481">Przetestuj **Edytowanie** , **szczegóły** i **:::no-loc(Delete):::** linki.</span><span class="sxs-lookup"><span data-stu-id="3ea32-481">Test the **Edit** , **Details** , and **:::no-loc(Delete):::** links.</span></span>
...
>  wprowadzenie [Dalej: Rusztowania :::no-loc(Razor)::: Strony](xref:tutorials/razor-pages/page)</span><span class="sxs-lookup"><span data-stu-id="3ea32-484">[Previous: Get Started](xref:tutorials/razor-pages/razor-pages-start)
[Next: Scaffolded :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/page)</span></span>
...
<span data-ttu-id="3ea32-494">Kliknij prawym przyciskiem myszy projekt **:::no-loc(Razor)::: PagesMovie** > **Dodaj**  >  **Nowy folder**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-494">Right-click the **:::no-loc(Razor):::PagesMovie** project > **Add** > **New Folder**.</span></span> <span data-ttu-id="3ea32-495">Nazwij *modele* folderów.</span><span class="sxs-lookup"><span data-stu-id="3ea32-495">Name the folder *Models*.</span></span>
...
<span data-ttu-id="3ea32-520">W :::no-loc(Razor)::: projekcie PagesMovie Utwórz nowy folder o nazwie *Data*.</span><span class="sxs-lookup"><span data-stu-id="3ea32-520">In the :::no-loc(Razor):::PagesMovie project, create a new folder named *Data*.</span></span> 
<span data-ttu-id="3ea32-521">Dodaj następującą `:::no-loc(Razor):::PagesMovieContext` klasę do folderu *danych* :</span><span class="sxs-lookup"><span data-stu-id="3ea32-521">Add the following `:::no-loc(Razor):::PagesMovieContext` class to the *Data* folder:</span></span>
...
<span data-ttu-id="3ea32-526">Dodaj parametry połączenia do *:::no-loc(appsettings.json):::* pliku, jak pokazano w następującym wyróżnionym kodzie:</span><span class="sxs-lookup"><span data-stu-id="3ea32-526">Add a connection string to the *:::no-loc(appsettings.json):::* file as shown in the following highlighted code:</span></span>
...
* <span data-ttu-id="3ea32-535">W **oknie narzędzia rozwiązania** kliknij projekt *:::no-loc(Razor)::: PagesMovie* , a następnie wybierz pozycję **Dodaj**  >  **Nowy folder**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-535">In **Solution Tool Window** , control-click the *:::no-loc(Razor):::PagesMovie* project, and then select **Add** > **New Folder**.</span></span> <span data-ttu-id="3ea32-536">Nazwij *modele* folderów.</span><span class="sxs-lookup"><span data-stu-id="3ea32-536">Name the folder *Models*.</span></span>
...
<span data-ttu-id="3ea32-555">:::no-loc(Create)::: folder *stron/filmów* :</span><span class="sxs-lookup"><span data-stu-id="3ea32-555">:::no-loc(Create)::: a *Pages/Movies* folder:</span></span>
...
<span data-ttu-id="3ea32-560">W oknie dialogowym **Dodawanie szkieletu** wybierz pozycję **:::no-loc(Razor)::: strony z użyciem Entity Framework (CRUD)** > **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-560">In the **Add Scaffold** dialog, select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **Add**.</span></span>

![Obraz z poprzednich instrukcji.](model/_static/add_scaffold.png)

<span data-ttu-id="3ea32-562">Wypełnij okno dialogowe **Dodawanie :::no-loc(Razor)::: stron przy użyciu Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="3ea32-562">Complete the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>
<!-- In the next section, change 
(plus) sign and accept the generated name 
to use Data, it should not use models. That will make the namespace the same for the VS version and the CLI version
-->

* <span data-ttu-id="3ea32-563">Z listy rozwijanej **Klasa modelu** wybierz pozycję **film ( :::no-loc(Razor)::: PagesMovie. models)**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-563">In the **Model class** drop down, select **Movie (:::no-loc(Razor):::PagesMovie.Models)**.</span></span>
* <span data-ttu-id="3ea32-564">W wierszu **klasy kontekstu danych** wybierz **+** znak (plus), a następnie zaakceptuj wygenerowaną nazwę **:::no-loc(Razor)::: PagesMovie. models. :::no-loc(Razor)::: PagesMovieContext**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-564">In the **Data context class** row, select the **+** (plus) sign and accept the generated name **:::no-loc(Razor):::PagesMovie.Models.:::no-loc(Razor):::PagesMovieContext**.</span></span>
...
<span data-ttu-id="3ea32-567">*:::no-loc(appsettings.json):::* Plik zostanie zaktualizowany przy użyciu parametrów połączenia używanych do nawiązywania połączenia z lokalną bazą danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-567">The *:::no-loc(appsettings.json):::* file is updated with the connection string used to connect to a local database.</span></span>
...
| `--referenceScriptLibraries` | <span data-ttu-id="3ea32-579">Dodaje `_ValidationScriptsPartial` do edycji i :::no-loc(Create)::: stron</span><span class="sxs-lookup"><span data-stu-id="3ea32-579">Adds `_ValidationScriptsPartial` to Edit and :::no-loc(Create)::: pages</span></span> |
...
<span data-ttu-id="3ea32-583">:::no-loc(Create)::: folder *stron/filmów* :</span><span class="sxs-lookup"><span data-stu-id="3ea32-583">:::no-loc(Create)::: a *Pages/Movies* folder:</span></span>
...
<span data-ttu-id="3ea32-588">W oknie dialogowym **Dodawanie nowej szkieletu** wybierz pozycję **:::no-loc(Razor)::: strony z użyciem Entity Framework (CRUD)** > **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-588">In the **Add New Scaffolding** dialog, select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **Add**.</span></span>

![Obraz z poprzednich instrukcji.](model/_static/add_scaffoldMac.png)

<span data-ttu-id="3ea32-590">Wypełnij okno dialogowe **Dodawanie :::no-loc(Razor)::: stron przy użyciu Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="3ea32-590">Complete the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>
...
* <span data-ttu-id="3ea32-592">W wierszu **klasy kontekstu danych** wpisz wybierz **:::no-loc(Razor)::: PagesMovieContext** to spowoduje utworzenie nowej klasy kontekstu bazy danych z poprawną przestrzenią nazw.</span><span class="sxs-lookup"><span data-stu-id="3ea32-592">In the **Data context class** row, type select the **:::no-loc(Razor):::PagesMovieContext** this will create a new database context class with the correct namespace.</span></span> <span data-ttu-id="3ea32-593">W takim przypadku będzie to **:::no-loc(Razor)::: PagesMovie. models. :::no-loc(Razor)::: PagesMovieContext**.</span><span class="sxs-lookup"><span data-stu-id="3ea32-593">In this case it will be  **:::no-loc(Razor):::PagesMovie.Models.:::no-loc(Razor):::PagesMovieContext**.</span></span>
...
<span data-ttu-id="3ea32-596">*:::no-loc(appsettings.json):::* Plik zostanie zaktualizowany przy użyciu parametrów połączenia używanych do nawiązywania połączenia z lokalną bazą danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-596">The *:::no-loc(appsettings.json):::* file is updated with the connection string used to connect to a local database.</span></span>
...
* <span data-ttu-id="3ea32-599">*Strony/filmy* : :::no-loc(Create)::: , :::no-loc(Delete)::: , szczegóły, Edytuj i :::no-loc(Index)::: .</span><span class="sxs-lookup"><span data-stu-id="3ea32-599">*Pages/Movies* : :::no-loc(Create):::, :::no-loc(Delete):::, Details, Edit, and :::no-loc(Index):::.</span></span>
* <span data-ttu-id="3ea32-600">*Dane/ :::no-loc(Razor)::: PagesMovieContext.cs*</span><span class="sxs-lookup"><span data-stu-id="3ea32-600">*Data/:::no-loc(Razor):::PagesMovieContext.cs*</span></span>
...
<span data-ttu-id="3ea32-612">`Add-Migration`Polecenie generuje kod, aby utworzyć początkowy schemat bazy danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-612">The `Add-Migration` command generates code to create the initial database schema.</span></span> <span data-ttu-id="3ea32-613">Schemat jest oparty na modelu określonym w `DbContext` , w pliku *:::no-loc(Razor)::: PagesMovieContext.cs* .</span><span class="sxs-lookup"><span data-stu-id="3ea32-613">The schema is based on the model specified in the `DbContext`, in the *:::no-loc(Razor):::PagesMovieContext.cs* file.</span></span> <span data-ttu-id="3ea32-614">`Initial:::no-loc(Create):::`Argument jest używany do nazwy migracji.</span><span class="sxs-lookup"><span data-stu-id="3ea32-614">The `Initial:::no-loc(Create):::` argument is used to name the migration.</span></span> <span data-ttu-id="3ea32-615">Można użyć dowolnej nazwy, ale według Konwencji Nazwa opisująca migrację jest używana.</span><span class="sxs-lookup"><span data-stu-id="3ea32-615">Any name can be used, but by convention a name that describes the migration is used.</span></span> <span data-ttu-id="3ea32-616">Aby uzyskać więcej informacji, zobacz <xref:data/ef-mvc/migrations>.</span><span class="sxs-lookup"><span data-stu-id="3ea32-616">For more information, see <xref:data/ef-mvc/migrations>.</span></span>

<span data-ttu-id="3ea32-617">`Update-Database`Polecenie uruchamia `Up` metodę w pliku *migrations/ \<time-stamp> _Initial :::no-loc(Create)::: . cs* .</span><span class="sxs-lookup"><span data-stu-id="3ea32-617">The `Update-Database` command runs the `Up` method in the *Migrations/\<time-stamp>_Initial:::no-loc(Create):::.cs* file.</span></span> <span data-ttu-id="3ea32-618">`Up`Metoda tworzy bazę danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-618">The `Up` method creates the database.</span></span>
...
<span data-ttu-id="3ea32-627">ASP.NET Core jest skompilowana z [iniekcją zależności](xref:fundamentals/dependency-injection).</span><span class="sxs-lookup"><span data-stu-id="3ea32-627">ASP.NET Core is built with [dependency injection](xref:fundamentals/dependency-injection).</span></span> <span data-ttu-id="3ea32-628">Usługi (takie jak kontekst kontekstu bazy danych EF Core) są rejestrowane z iniekcją zależności podczas uruchamiania aplikacji.</span><span class="sxs-lookup"><span data-stu-id="3ea32-628">Services (such as the EF Core database context context) are registered with dependency injection during application startup.</span></span> <span data-ttu-id="3ea32-629">Składniki wymagające tych usług (takie jak :::no-loc(Razor)::: strony) są udostępniane przez parametry konstruktora.</span><span class="sxs-lookup"><span data-stu-id="3ea32-629">Components that require these services (such as :::no-loc(Razor)::: Pages) are provided these services via constructor parameters.</span></span> <span data-ttu-id="3ea32-630">Kod konstruktora, który pobiera wystąpienie kontekstu contextB kontekstu bazy danych jest wyświetlany w dalszej części tego samouczka.</span><span class="sxs-lookup"><span data-stu-id="3ea32-630">The constructor code that gets a database context contextB context instance is shown later in the tutorial.</span></span>
...
<span data-ttu-id="3ea32-634">`:::no-loc(Razor):::PagesMovieContext`Współrzędne EF Core funkcje, takie jak :::no-loc(Create)::: , Odczyt, aktualizacja i :::no-loc(Delete)::: , dla `Movie` modelu.</span><span class="sxs-lookup"><span data-stu-id="3ea32-634">The `:::no-loc(Razor):::PagesMovieContext` coordinates EF Core functionality, such as :::no-loc(Create):::, Read, Update, and :::no-loc(Delete):::, for the `Movie` model.</span></span> <span data-ttu-id="3ea32-635">Kontekst danych ( `:::no-loc(Razor):::PagesMovieContext` ) pochodzi od [Microsoft. EntityFrameworkCore. DbContext](xref:Microsoft.EntityFrameworkCore.DbContext).</span><span class="sxs-lookup"><span data-stu-id="3ea32-635">The data context (`:::no-loc(Razor):::PagesMovieContext`) is derived from [Microsoft.EntityFrameworkCore.DbContext](xref:Microsoft.EntityFrameworkCore.DbContext).</span></span> <span data-ttu-id="3ea32-636">Kontekst danych określa, które jednostki są uwzględnione w modelu danych.</span><span class="sxs-lookup"><span data-stu-id="3ea32-636">The data context specifies which entities are included in the data model.</span></span>
...
* <span data-ttu-id="3ea32-648">Przetestuj **:::no-loc(Create):::** link.</span><span class="sxs-lookup"><span data-stu-id="3ea32-648">Test the **:::no-loc(Create):::** link.</span></span>
...
* <span data-ttu-id="3ea32-653">Przetestuj **Edytowanie** , **szczegóły** i **:::no-loc(Delete):::** linki.</span><span class="sxs-lookup"><span data-stu-id="3ea32-653">Test the **Edit** , **Details** , and **:::no-loc(Delete):::** links.</span></span>
...
>  wprowadzenie [Dalej: Rusztowania :::no-loc(Razor)::: Strony](xref:tutorials/razor-pages/page)</span><span class="sxs-lookup"><span data-stu-id="3ea32-656">[Previous: Get Started](xref:tutorials/razor-pages/razor-pages-start)
[Next: Scaffolded :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/page)</span></span>
