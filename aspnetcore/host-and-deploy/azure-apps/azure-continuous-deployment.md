...
1. W **Team Explorer** wybierz pozycję **Strona główna** (ikona główna) >   >  **Ustawienia repozytorium** ustawień.
...
1. Wybierz pozycję  >    >  **Akcje** synchronizacji głównej  >  **Otwórz wiersz polecenia**. Zostanie otwarty wiersz polecenia w katalogu projektu.
...
1. Wybierz pozycję  >    >  **Akcje** synchronizacji narzędzia  >  **wypychanie**.
