<span data-ttu-id="0fcf8-101">Uruchom następujące polecenia środowiska uruchomieniowego platformy .NET:</span><span class="sxs-lookup"><span data-stu-id="0fcf8-101">Run the following .NET CLI commands:</span></span>
