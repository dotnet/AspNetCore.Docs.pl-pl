<span data-ttu-id="1e4eb-101">`FetchData`Składnik pokazuje, jak:</span><span class="sxs-lookup"><span data-stu-id="1e4eb-101">The `FetchData` component shows how to:</span></span>
