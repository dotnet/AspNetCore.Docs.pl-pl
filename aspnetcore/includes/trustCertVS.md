<span data-ttu-id="c6bd5-101">Program Visual Studio wyświetla następujące okno dialogowe:</span><span class="sxs-lookup"><span data-stu-id="c6bd5-101">Visual Studio displays the following dialog:</span></span>
