<span data-ttu-id="94186-101">Składnik `FetchData` pokazuje, jak:</span><span class="sxs-lookup"><span data-stu-id="94186-101">The `FetchData` component shows how to:</span></span>
