...
---
# <a name="build-a-no-locblazor-todo-list-app"></a><span data-ttu-id="eeae4-103">Tworzenie aplikacji z listą zadań do wykonania Blazor</span><span class="sxs-lookup"><span data-stu-id="eeae4-103">Build a Blazor todo list app</span></span>
...
<span data-ttu-id="eeae4-105">W tym samouczku pokazano, jak utworzyć i zmodyfikować Blazor aplikację.</span><span class="sxs-lookup"><span data-stu-id="eeae4-105">This tutorial shows you how to build and modify a Blazor app.</span></span> <span data-ttu-id="eeae4-106">Omawiane kwestie:</span><span class="sxs-lookup"><span data-stu-id="eeae4-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="eeae4-107">Tworzenie projektu aplikacji z listą zadań do zrobienia Blazor</span><span class="sxs-lookup"><span data-stu-id="eeae4-107">Create a todo list Blazor app project</span></span>
> * <span data-ttu-id="eeae4-108">Modyfikuj Razor składniki</span><span class="sxs-lookup"><span data-stu-id="eeae4-108">Modify Razor components</span></span>
...
> * <span data-ttu-id="eeae4-110">Używanie routingu w Blazor aplikacji</span><span class="sxs-lookup"><span data-stu-id="eeae4-110">Use routing in a Blazor app</span></span>
...
## <a name="create-a-todo-list-no-locblazor-app"></a><span data-ttu-id="eeae4-113">Tworzenie aplikacji z listą zadań do zrobienia Blazor</span><span class="sxs-lookup"><span data-stu-id="eeae4-113">Create a todo list Blazor app</span></span>

1. <span data-ttu-id="eeae4-114">Utwórz nową Blazor aplikację o nazwie `TodoList` w powłoce poleceń:</span><span class="sxs-lookup"><span data-stu-id="eeae4-114">Create a new Blazor app named `TodoList` in a command shell:</span></span>
...
1. <span data-ttu-id="eeae4-118">Dodaj nowy `Todo` Razor składnik do aplikacji w `Pages` folderze przy użyciu następującego polecenia:</span><span class="sxs-lookup"><span data-stu-id="eeae4-118">Add a new `Todo` Razor component to the app in the `Pages` folder using the following command:</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="eeae4-159">Tworzenie projektu aplikacji z listą zadań do zrobienia Blazor</span><span class="sxs-lookup"><span data-stu-id="eeae4-159">Create a todo list Blazor app project</span></span>
> * <span data-ttu-id="eeae4-160">Modyfikuj Razor składniki</span><span class="sxs-lookup"><span data-stu-id="eeae4-160">Modify Razor components</span></span>
...
> * <span data-ttu-id="eeae4-162">Używanie routingu w Blazor aplikacji</span><span class="sxs-lookup"><span data-stu-id="eeae4-162">Use routing in a Blazor app</span></span>

<span data-ttu-id="eeae4-163">Informacje o narzędziach dla ASP.NET Core Blazor :</span><span class="sxs-lookup"><span data-stu-id="eeae4-163">Learn about tooling for ASP.NET Core Blazor:</span></span>
