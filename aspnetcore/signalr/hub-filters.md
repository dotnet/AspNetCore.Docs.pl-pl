...
---
# <a name="use-hub-filters-in-aspnet-core-no-locsignalr"></a><span data-ttu-id="120c5-103">Używanie filtrów centrum w ASP.NET Core :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="120c5-103">Use hub filters in ASP.NET Core :::no-loc(SignalR):::</span></span>
