...
### <a name="no-locrazor-class-library"></a>RazorBiblioteka klas
...
Zgodnie z opisem w dokumentacji dotyczącej [różnic między wcześniejszymi wersjami routingu](xref:fundamentals/routing#differences-from-earlier-versions-of-routing)istnieją pewne różnice w generowaniu linków ( `Url.Link` na przykład przy użyciu i podobne interfejsy API). Są to moduły:
...
## <a name="no-locidentity-ui"></a>IdentityINTERFEJSU użytkownika
