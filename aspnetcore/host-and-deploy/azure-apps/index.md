...
Aby opublikować [wdrożenie samodzielne (SCD)](/dotnet/core/deploying/#self-contained-deployments-scd), skonfiguruj SCD w tym `Publish` kroku i podaj [Identyfikator czasu wykonywania (RID)](/dotnet/core/rid-catalog).
