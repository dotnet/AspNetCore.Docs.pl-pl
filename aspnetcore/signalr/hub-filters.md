...
---
# <a name="use-hub-filters-in-aspnet-core-no-locsignalr"></a><span data-ttu-id="51a40-103">Używanie filtrów centrum w ASP.NET Core SignalR</span><span class="sxs-lookup"><span data-stu-id="51a40-103">Use hub filters in ASP.NET Core SignalR</span></span>
