...
## <a name="changes-to-no-locblazor-app-routing-logic-in-501"></a>Zmiany Blazor w logice routingu aplikacji w 5.0.1
...
>
> Możliwość ustawienia opcji na `false` lub pozostawienie jej nieustawienia, która domyślnie jest opcją dla `false` , *jest dostępna tylko w celu zapewnienia zgodności z poprzednimi wersjami*.
>
