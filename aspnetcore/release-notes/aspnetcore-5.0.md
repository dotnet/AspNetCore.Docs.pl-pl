...
<xref:Microsoft.AspNetCore.Mvc.FromBodyAttribute> obsługuje teraz Konfigurowanie opcji, która umożliwia określenie parametrów lub właściwości jako opcjonalnych:
