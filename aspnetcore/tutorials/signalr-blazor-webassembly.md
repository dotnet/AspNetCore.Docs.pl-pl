...
---
# <a name="use-aspnet-core-no-locsignalr-with-no-locblazor-webassembly"></a><span data-ttu-id="1fe59-103">Użyj ASP.NET Core :::no-loc(SignalR)::: z :::no-loc(Blazor WebAssembly):::</span><span class="sxs-lookup"><span data-stu-id="1fe59-103">Use ASP.NET Core :::no-loc(SignalR)::: with :::no-loc(Blazor WebAssembly):::</span></span>
...
<span data-ttu-id="1fe59-105">Ten samouczek uczy się podstaw tworzenia aplikacji w czasie rzeczywistym przy użyciu :::no-loc(SignalR)::: programu z usługą :::no-loc(Blazor WebAssembly)::: .</span><span class="sxs-lookup"><span data-stu-id="1fe59-105">This tutorial teaches the basics of building a real-time app using :::no-loc(SignalR)::: with :::no-loc(Blazor WebAssembly):::.</span></span> <span data-ttu-id="1fe59-106">Omawiane kwestie:</span><span class="sxs-lookup"><span data-stu-id="1fe59-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="1fe59-107">Tworzenie :::no-loc(Blazor WebAssembly)::: projektu hostowanej aplikacji</span><span class="sxs-lookup"><span data-stu-id="1fe59-107">Create a :::no-loc(Blazor WebAssembly)::: Hosted app project</span></span>
> * <span data-ttu-id="1fe59-108">Dodawanie :::no-loc(SignalR)::: biblioteki klienta</span><span class="sxs-lookup"><span data-stu-id="1fe59-108">Add the :::no-loc(SignalR)::: client library</span></span>
> * <span data-ttu-id="1fe59-109">Dodawanie :::no-loc(SignalR)::: centrum</span><span class="sxs-lookup"><span data-stu-id="1fe59-109">Add a :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="1fe59-110">Dodaj :::no-loc(SignalR)::: usługi i punkt końcowy :::no-loc(SignalR)::: centrum</span><span class="sxs-lookup"><span data-stu-id="1fe59-110">Add :::no-loc(SignalR)::: services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="1fe59-111">Dodawanie :::no-loc(Razor)::: kodu składnika dla rozmowy</span><span class="sxs-lookup"><span data-stu-id="1fe59-111">Add :::no-loc(Razor)::: component code for chat</span></span>
...
## <a name="create-a-hosted-no-locblazor-webassembly-app-project"></a><span data-ttu-id="1fe59-127">Tworzenie projektu hostowanej :::no-loc(Blazor WebAssembly)::: aplikacji</span><span class="sxs-lookup"><span data-stu-id="1fe59-127">Create a hosted :::no-loc(Blazor WebAssembly)::: app project</span></span>
...
1. <span data-ttu-id="1fe59-133">Wybierz pozycję **:::no-loc(Blazor)::: aplikacja** i wybierz pozycję **dalej** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-133">Select **:::no-loc(Blazor)::: App** and select **Next** .</span></span>

1. <span data-ttu-id="1fe59-134">Wpisz `:::no-loc(Blazor)::::::no-loc(SignalR):::App` wartość w polu **Nazwa projektu** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-134">Type `:::no-loc(Blazor)::::::no-loc(SignalR):::App` in the **Project name** field.</span></span> <span data-ttu-id="1fe59-135">Potwierdź, że wpis **lokalizacji** jest poprawny lub podaj lokalizację dla projektu.</span><span class="sxs-lookup"><span data-stu-id="1fe59-135">Confirm the **Location** entry is correct or provide a location for the project.</span></span> <span data-ttu-id="1fe59-136">Wybierz pozycję **Utwórz** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-136">Select **Create** .</span></span>

1. <span data-ttu-id="1fe59-137">Wybierz szablon **:::no-loc(Blazor WebAssembly)::: aplikacji** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-137">Choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span>
...
1. <span data-ttu-id="1fe59-149">Wybierz szablon **:::no-loc(Blazor WebAssembly)::: aplikacji** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-149">Choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span> <span data-ttu-id="1fe59-150">Wybierz opcję **Dalej** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-150">Select **Next** .</span></span>
...
1. <span data-ttu-id="1fe59-154">W polu **Nazwa projektu** Nadaj nazwę aplikacji `:::no-loc(Blazor)::::::no-loc(SignalR):::App` .</span><span class="sxs-lookup"><span data-stu-id="1fe59-154">In the **Project Name** field, name the app `:::no-loc(Blazor)::::::no-loc(SignalR):::App`.</span></span> <span data-ttu-id="1fe59-155">Wybierz pozycję **Utwórz** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-155">Select **Create** .</span></span>
...
## <a name="add-the-no-locsignalr-client-library"></a><span data-ttu-id="1fe59-161">Dodawanie :::no-loc(SignalR)::: biblioteki klienta</span><span class="sxs-lookup"><span data-stu-id="1fe59-161">Add the :::no-loc(SignalR)::: client library</span></span>
...
1. <span data-ttu-id="1fe59-163">W **Eksplorator rozwiązań** kliknij prawym przyciskiem myszy `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` projekt i wybierz polecenie **Zarządzaj pakietami NuGet** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-163">In **Solution Explorer** , right-click the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project and select **Manage NuGet Packages** .</span></span>
...
1. <span data-ttu-id="1fe59-165">Po wybraniu **przycisku Przeglądaj** wpisz `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` w polu wyszukiwania.</span><span class="sxs-lookup"><span data-stu-id="1fe59-165">With **Browse** selected, type `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` in the search box.</span></span>

1. <span data-ttu-id="1fe59-166">W wynikach wyszukiwania wybierz [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) pakiet i wybierz pozycję **Zainstaluj** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-166">In the search results, select the [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) package and select **Install** .</span></span>
...
1. <span data-ttu-id="1fe59-172">Na pasku bocznym **rozwiązania** kliknij prawym przyciskiem myszy `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` projekt i wybierz polecenie **Zarządzaj pakietami NuGet** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-172">In the **Solution** sidebar, right-click the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project and select **Manage NuGet Packages** .</span></span>
...
1. <span data-ttu-id="1fe59-174">Po wybraniu **przycisku Przeglądaj** wpisz `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` w polu wyszukiwania.</span><span class="sxs-lookup"><span data-stu-id="1fe59-174">With **Browse** selected, type `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` in the search box.</span></span>

1. <span data-ttu-id="1fe59-175">W wynikach wyszukiwania zaznacz pole wyboru obok [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) pakietu i wybierz polecenie **Dodaj pakiet** .</span><span class="sxs-lookup"><span data-stu-id="1fe59-175">In the search results, select the check box next to the [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) package and select **Add Package** .</span></span>
...
## <a name="add-a-no-locsignalr-hub"></a><span data-ttu-id="1fe59-179">Dodawanie :::no-loc(SignalR)::: centrum</span><span class="sxs-lookup"><span data-stu-id="1fe59-179">Add a :::no-loc(SignalR)::: hub</span></span>

<span data-ttu-id="1fe59-180">W `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` projekcie Utwórz `Hubs` folder (plural) i Dodaj następującą `ChatHub` klasę ( `Hubs/ChatHub.cs` ):</span><span class="sxs-lookup"><span data-stu-id="1fe59-180">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` project, create a `Hubs` (plural) folder and add the following `ChatHub` class (`Hubs/ChatHub.cs`):</span></span>
...
## <a name="add-services-and-an-endpoint-for-the-no-locsignalr-hub"></a><span data-ttu-id="1fe59-181">Dodaj usługi i punkt końcowy :::no-loc(SignalR)::: centrum</span><span class="sxs-lookup"><span data-stu-id="1fe59-181">Add services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>

1. <span data-ttu-id="1fe59-182">W `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` projekcie Otwórz `Startup.cs` plik.</span><span class="sxs-lookup"><span data-stu-id="1fe59-182">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` project, open the `Startup.cs` file.</span></span>
...
1. <span data-ttu-id="1fe59-184">Dodaj :::no-loc(SignalR)::: i Odpowiedz usługi pośredniczące kompresji w programie `Startup.ConfigureServices` :</span><span class="sxs-lookup"><span data-stu-id="1fe59-184">Add :::no-loc(SignalR)::: and Response Compression Middleware services to `Startup.ConfigureServices`:</span></span>
...
## <a name="add-no-locrazor-component-code-for-chat"></a><span data-ttu-id="1fe59-188">Dodawanie :::no-loc(Razor)::: kodu składnika dla rozmowy</span><span class="sxs-lookup"><span data-stu-id="1fe59-188">Add :::no-loc(Razor)::: component code for chat</span></span>

1. <span data-ttu-id="1fe59-189">W `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` projekcie Otwórz `Pages/Index.razor` plik.</span><span class="sxs-lookup"><span data-stu-id="1fe59-189">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project, open the `Pages/Index.razor` file.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="1fe59-226">Tworzenie :::no-loc(Blazor WebAssembly)::: projektu hostowanej aplikacji</span><span class="sxs-lookup"><span data-stu-id="1fe59-226">Create a :::no-loc(Blazor WebAssembly)::: Hosted app project</span></span>
> * <span data-ttu-id="1fe59-227">Dodawanie :::no-loc(SignalR)::: biblioteki klienta</span><span class="sxs-lookup"><span data-stu-id="1fe59-227">Add the :::no-loc(SignalR)::: client library</span></span>
> * <span data-ttu-id="1fe59-228">Dodawanie :::no-loc(SignalR)::: centrum</span><span class="sxs-lookup"><span data-stu-id="1fe59-228">Add a :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="1fe59-229">Dodaj :::no-loc(SignalR)::: usługi i punkt końcowy :::no-loc(SignalR)::: centrum</span><span class="sxs-lookup"><span data-stu-id="1fe59-229">Add :::no-loc(SignalR)::: services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="1fe59-230">Dodawanie :::no-loc(Razor)::: kodu składnika dla rozmowy</span><span class="sxs-lookup"><span data-stu-id="1fe59-230">Add :::no-loc(Razor)::: component code for chat</span></span>

<span data-ttu-id="1fe59-231">Aby dowiedzieć się więcej na temat tworzenia :::no-loc(Blazor)::: aplikacji, zapoznaj się z :::no-loc(Blazor)::: dokumentacją:</span><span class="sxs-lookup"><span data-stu-id="1fe59-231">To learn more about building :::no-loc(Blazor)::: apps, see the :::no-loc(Blazor)::: documentation:</span></span>

> [!div class="nextstepaction"]
> <span data-ttu-id="1fe59-232"><xref:blazor/index>
> [Uwierzytelnianie tokenu okaziciela z użyciem :::no-loc(Identity)::: serwera, obiektów WebSockets i zdarzeń Server-Sent](xref:signalr/authn-and-authz#bearer-token-authentication)</span><span class="sxs-lookup"><span data-stu-id="1fe59-232"><xref:blazor/index>
...
* [<span data-ttu-id="1fe59-234">:::no-loc(SignalR)::: negocjowanie między źródłami na potrzeby uwierzytelniania</span><span class="sxs-lookup"><span data-stu-id="1fe59-234">:::no-loc(SignalR)::: cross-origin negotiation for authentication</span></span>](xref:blazor/fundamentals/additional-scenarios#signalr-cross-origin-negotiation-for-authentication)
