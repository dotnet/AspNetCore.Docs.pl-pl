# <a name="visual-studio"></a>[<span data-ttu-id="7b2e3-101">Visual Studio</span><span class="sxs-lookup"><span data-stu-id="7b2e3-101">Visual Studio</span></span>](#tab/visual-studio)
